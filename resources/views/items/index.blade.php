                    ...
                    <table class="min-w-full leading-normal">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3 px-6 text-left bg-gray-200 dark:bg-gray-700 border-b border-gray-300 dark:border-gray-600 text-sm font-semibold text-gray-800 dark:text-gray-300 uppercase tracking-wider">Price</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-900">
                                <td class="py-4 px-6 border-b border-gray-300 dark:border-gray-600 text-sm">{{ $item->name }}</td>
                                <td class="py-4 px-6 border-b border-gray-300 dark:border-gray-600 text-sm">{{ $item->price }}</td>
